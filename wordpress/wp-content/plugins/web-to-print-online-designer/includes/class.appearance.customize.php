...
if( !class_exists('NBD_Appearance_Customize') ) {
    class NBD_Appearance_Customize{
        ...
        public function nbds_get_product_template(){
            ...
            if( $product_id != 0 ){
                ...
                $sql           .= " WHERE publish = 1 AND product_id = {$product_id} AND publish = 1"; 
	...
	public function add_sections( $wp_customize ) {
            $wp_customize->add_panel( 'nbdesigner', array(
                    ...
                    'theme_supports' => '',
                    'title'          => __( 'Nbdesigner', 'web-to-print-online-designer' ),
            ) );
        ...
        public function add_gallery_page_section( $wp_customize ){
            ...
            $wp_customize->add_setting(
                'nbdesigner_gallery_dide_sidebar',
                array(
                    'default'              => 'n',
                    'type'                 => 'option',
                    'capability'           => 'manage_woocommerce'
            ...
            $wp_customize->add_control(
                'nbdesigner_gallery_dide_sidebar', array(
                    'label' => __('Hide gallery sidebar', 'web-to-print-online-designer'),
                    'description' => __('Choose whether the sidebar is hidden or not.', 'web-to-print-online-designer'),
                    'section' => 'nbdesigner_gallery_page',
                    'settings' => 'nbdesigner_gallery_dide_sidebar',
                    'type' => 'radio',
                    'choices' => array(
            ...
            $wp_customize->add_control(
                'nbdesigner_gallery_column', array(
                    'label' => __('Gallery page', 'web-to-print-online-designer'),
                    'description' => __('How many columns of templates should be shown in gallery page?', 'woocommerce'),
                    'section' => 'nbdesigner_gallery_page',
            ...
            $wp_customize->add_control(
                'nbdesigner_artist_gallery_column', array(
                    'label' => __('Artist page', 'web-to-print-online-designer'),
                    'description' => __('How many columns of templates should be shown in artist page?', 'woocommerce'),
                    'section' => 'nbdesigner_gallery_page',
            ...
            $wp_customize->add_control(
                'nbdesigner_gallery_gutter', array(
                    'label' => __('Gallery element gutter', 'web-to-print-online-designer'),
                    'description' => __('Gallery element gutter in px', 'web-to-print-online-designer'),
                    'section' => 'nbdesigner_gallery_page',
