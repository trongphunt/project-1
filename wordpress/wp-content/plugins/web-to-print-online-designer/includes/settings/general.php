...
//                            'nbdesigner_download_design_jpg' => __('JPG ( require PHP Imagick )', 'web-to-print-online-designer'),
                            'nbdesigner_download_design_jpg_cmyk' => __('JPG ( require PHP Imagick )', 'web-to-print-online-designer'),
                ...
                'tools' => array(
                    ...
                    array(
                        'title' => __( 'Fix image URL after change domain', 'web-to-print-online-designer'),
                        'description'   => __( 'Fix image urls in templates or order designs after change domain or setup SSL.'),
                    ...
                    array(
                        'title' => __( 'Fix lost images when export design into PDF', 'web-to-print-online-designer'),
                        'description'   => '',
                    ...
                    array(
                        'title' => __( 'Additional upload file types', 'web-to-print-online-designer'),
                        ...
                        'col1' 		=> __( 'Extension', 'web-to-print-online-designer'),
                        'col2' 		=> __( 'MIME Type', 'web-to-print-online-designer'),
