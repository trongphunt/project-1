    ...
    class NBD_Template_Field_Mapping{
        ...
        public function add_sub_menu(){
            if(current_user_can('manage_nbd_tool')){
                add_submenu_page(
                    'nbdesigner', __('Template Field Mapping', 'web-to-print-online-designer'), __('Template Fields', 'web-to-print-online-designer'), 'manage_nbd_tool', 'nbd_template_mapping', array($this, 'template_mapping')
                );
            }
        }
        public function design_tool_setting( $settings ){
            $settings['misc'][] = array(
                'title'         => __( 'Enable template mapping', 'web-to-print-online-designer'),
                'id' 		=> 'nbdesigner_enable_template_mapping',
                'description'   => sprintf(__('Check this option if you want that the template fields( layers ) will be filled automatically. <a href="%s" target="_blank">Manage template fields mapping</a>', 'web-to-print-online-designer'), esc_url(admin_url('admin.php?page=nbd_template_mapping'))),
                'default'	=> 'yes',
                'type' 		=> 'radio',
                'options'       => array(
            ...
            $settings['misc'][] = array(
                'title'         => __( 'Enable vCard', 'web-to-print-online-designer'),
            ...
            if( isset( $_POST['nbtn-admin-action'] ) && $_POST['nbtn-admin-action'] == 'fields-save' ){
                ...
                for ( $i = 0; $i <= $max; $i ++ ) {
                    ...
                    $new_fields[ $name ]    = array(
                        'name'          =>  $_POST['field_name'][ $i ] != '' ? $_POST['field_name'][ $i ] : __('Field Name', 'web-to-print-online-designer'),
        ...
        public function get_vcard_field_options(){
            $vcard_field_options = array(
                ...
                'address' =>  array(
                    'label'     =>  __('Address', 'web-to-print-online-designer'),
                    'options'   => $this->get_vcard_address_option()
                ),
                'city' =>  array(
                    'label'     =>  __('City', 'web-to-print-online-designer'),
                    'options'   => $this->get_vcard_city_option()
                ),
                'postcode' =>  array(
                    'label'     =>  __('Postcode', 'web-to-print-online-designer'),
                    'options'   => $this->get_vcard_postcode_option()
                ),
                'country' =>  array(
                    'label'     =>  __('Country', 'web-to-print-online-designer'),
                    'options'   => $this->get_vcard_country_option()
                ),
                'phone' =>  array(
                    'label'     =>  __('Phone', 'web-to-print-online-designer'),
                ...
                'website' =>  array(
                    'label'     =>  __('Website', 'web-to-print-online-designer'),
        ...
        public function get_connect_fields(){
            $fields             = array( 
                ''              => array(
                    "label" =>  __('-- Select a field --', 'web-to-print-online-designer')
                ),
                'user_firstname'    =>  array(
                    "label" =>  __('Wordpress - First name', 'web-to-print-online-designer')
                ),
                'user_lastname'     =>  array(
                    "label" =>  __('Wordpress - Last name', 'web-to-print-online-designer')
                ),
                'user_fullname'     =>  array(
                    "label" =>  __('Wordpress - Full name', 'web-to-print-online-designer')
                ),
                'display_name'   =>  array(
                    "label" =>  __('Wordpress - Display name', 'web-to-print-online-designer')
                ),
                'user_email'          =>  array(
                    "label" =>  __('Wordpress - Email', 'web-to-print-online-designer')
                ),
                'user_url'            =>  array(
                    "label" =>  __('Wordpress - Website', 'web-to-print-online-designer')
                ),
                'user_description'    =>  array(
                    "label" =>  __('Wordpress - Biographical Info', 'web-to-print-online-designer')
                )       
            );
            ...
            foreach( $billing_fields as $key => $billing_field ){
                if( $key == 'billing_address_2' ){
                    $billing_fields[ $key ][ 'label' ] = __('Woocommerce Billing - Street address 2', 'web-to-print-online-designer');
                } else {
                    $billing_fields[ $key ][ 'label' ] = __('Woocommerce Billing - ', 'web-to-print-online-designer') . $billing_field['label'];
                }
            }
            ...
            foreach( $shipping_fields as $key => $shipping_field ){
                if( $key == 'shipping_address_2' ){
                    $shipping_fields[ $key ][ 'label' ] = __('Woocommerce Shipping - Street address 2', 'web-to-print-online-designer');
                } else {
                    $shipping_fields[ $key ][ 'label' ] = __('Woocommerce Shipping - ', 'web-to-print-online-designer') . $shipping_field['label'];
                }
            }
        ...
        public function get_vcard_first_name_option(){
            $fields = array(
                ...
                'billing_first_name'    =>  array(
                    "label" =>  __('Woocommerce Billing - First name', 'web-to-print-online-designer')
                ),
                'shipping_first_name'    =>  array(
                    "label" =>  __('Woocommerce Shipping - First name', 'web-to-print-online-designer')
                )
            );
        ...
        public function get_vcard_last_name_option(){
            $fields = array(
                ...
                'billing_last_name'    =>  array(
                    "label" =>  __('Woocommerce Billing - Last name', 'web-to-print-online-designer')
                ),
                'shipping_last_name'    =>  array(
                    "label" =>  __('Woocommerce Shipping - Last name', 'web-to-print-online-designer')
                )
            );
        ...
        public function get_vcard_address_option(){
            $fields = array(
                'billing_address_1'    =>  array(
                    "label" =>  __('Woocommerce Billing - Address', 'web-to-print-online-designer')
                ),
                'shipping_address_1'    =>  array(
                    "label" =>  __('Woocommerce Shipping - Address', 'web-to-print-online-designer')
                )
            );
        ...
        public function get_vcard_city_option(){
            $fields = array(
                'billing_city'    =>  array(
                    "label" =>  __('Woocommerce Billing - City', 'web-to-print-online-designer')
                ),
                'shipping_city'    =>  array(
                    "label" =>  __('Woocommerce Shipping - City', 'web-to-print-online-designer')
                )
            );
        ...
        public function get_vcard_postcode_option(){
            $fields = array(
                'billing_postcode'    =>  array(
                    "label" =>  __('Woocommerce Billing - Postcode', 'web-to-print-online-designer')
                ),
                'shipping_postcode'    =>  array(
                    "label" =>  __('Woocommerce Shipping - Postcode', 'web-to-print-online-designer')
                )
            );
        ...
        public function get_vcard_country_option(){
            $fields = array(
                'billing_country'    =>  array(
                    "label" =>  __('Woocommerce Billing - Country', 'web-to-print-online-designer')
                ),
                'shipping_country'    =>  array(
                    "label" =>  __('Woocommerce Shipping - Country', 'web-to-print-online-designer')
                )
            );
        ...
        public function get_vcard_phone_option(){
            $fields = array(
                'billing_phone'    =>  array(
                    "label" =>  __('Woocommerce Billing - Phone', 'web-to-print-online-designer')
                )
            );
        ...
        public function get_vcard_email_option(){
            $fields = array(
                ...
                'billing_email'    =>  array(
                    "label" =>  __('Woocommerce Billing - Email', 'web-to-print-online-designer')
                )
            );
