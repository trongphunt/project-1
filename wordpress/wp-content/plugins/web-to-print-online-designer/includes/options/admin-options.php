...
//                $options[$key]['enable_con']         = isset( $options[$key]['enable_con'] ) ? $options[$key]['enable_con'] : 'n';
//                $options[$key]['con_type']           = isset( $options[$key]['con_type'] ) ? $options[$key]['con_type'] : 'n';
//                $options[$key]['con_logic']          = isset( $options[$key]['con_logic'] ) ? $options[$key]['con_logic'] : 'a';
//                $options[$key]['depend']             = isset( $options[$key]['depend'] ) ? $options[$key]['depend'] : array( 0 => array( 'id' => '', 'operator' => 'i', 'val' => '' ) );
