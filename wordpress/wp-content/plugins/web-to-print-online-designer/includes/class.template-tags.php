    ...
    class NBD_Template_Tag{
        ...
        public function add_sub_menu(){
            if(current_user_can('manage_nbd_tool')){
                add_submenu_page(
                    'nbdesigner', __('Template Tags', 'web-to-print-online-designer'), __('Template Tags', 'web-to-print-online-designer'), 'manage_nbd_tool', 'edit-tags.php?taxonomy=template_tag&post_type=product', null
                );
            }
        }
        public function init_taxonomy( ){
            register_taxonomy('template_tag', array('product'),
                apply_filters('register_taxonomy_template_tag', array(
                    ...
                    'show_tagcloud' => false,
                    'meta_box_cb'   => false,
                    'label'         => __('Template tags', 'web-to-print-online-designer'),
                    'labels'        => array(
                        'name'              => __('Template tags', 'web-to-print-online-designer'),
                        'singular_name'     => __('Template tag', 'web-to-print-online-designer'),
                        'search_items'      => __('Search Template tag', 'web-to-print-online-designer'),
                        'all_items'         => __('All Template tag', 'web-to-print-online-designer'),
                        'edit_item'         => __('Edit Template tag', 'web-to-print-online-designer'),
                        'update_item'       => __('Update Template tag', 'web-to-print-online-designer'),
                        'add_new_item'      => __('Add New Template tag', 'web-to-print-online-designer'),
                        'new_item_name'     => __('New Template tag', 'web-to-print-online-designer')
                    ),
        ...
        public function template_tag_columns( $columns ){
            ...
            $new_columns['thumb']       = __('Image', 'web-to-print-online-designer');
            $new_columns['name']        = __('Name', 'web-to-print-online-designer');
            $new_columns['featured']    = __('Featured', 'web-to-print-online-designer');
            $columns['handle']          = '';
        ...
        public function templates_info( $data, $templates ){
            ...
            $un_tag                     = array(
                'id'        => 0,
                'name'      => __('Templates', 'web-to-print-online-designer'),
        ...
        public function gallery_sidebar_tag_list(){
            $filter_term_ids    = isset( $_GET['tag'] ) ? $_GET['tag'] : '';
            $filter_tags        = $filter_term_ids != '' ? explode(',', $filter_term_ids) : array();
            $filter_colors_str  = isset( $_GET['color'] ) ? $_GET['color'] : '';
        ...
        public function gallery_tag_filter(){
            $term_ids   = isset( $_GET['tag'] ) ? $_GET['tag'] : '';
        ...
        public function get_color_list(){
            global $wpdb;
            $color_arr = array();
            $sql = "SELECT GROUP_CONCAT(colors SEPARATOR  ',') AS color_str FROM {$wpdb->prefix}nbdesigner_templates";
            $result = $wpdb->get_results($sql, 'ARRAY_A');
