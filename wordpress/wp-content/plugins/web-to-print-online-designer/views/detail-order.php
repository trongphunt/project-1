            ...
            <div id="nbd-convert-section">
                ...
                <div class="nbd-convert-con">
                    <div id="conver-png-to-jpg" >
                        <p class="nbd-convert-con-header"><?php _e('PNG', 'web-to-print-online-designer'); ?> <?php if( is_available_imagick() ) _e('( High quality images )', 'web-to-print-online-designer'); ?></p>
                        <div class="nbd-convert-con-inner">
