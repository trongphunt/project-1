<div class="toolbar-text" ng-show="stages[currentStage].states.isText">
            ...
            <div class="sub-menu" data-pos="center">
                <ul>
                    ...
                    <li ng-click="setTextAttribute('textAlign', 'justify')" class="sub-menu-item"
                        ...
                        ng-if="settings['nbdesigner_text_align_center'] == '1'"><i class="icon-nbd icon-nbd-format-align-justify nbd-tooltip-hover" title="<?php _e('Justify','web-to-print-online-designer'); ?>"></i></li>
                </ul>
            </div>
        </li>
    ...
    <ul class="nbd-main-menu menu-right">
        ...
        <li  ng-show="stages[currentStage].states.type == 'curvedText'"  ng-class="stages[currentStage].states.type == 'curvedText' && curvedText.active ? 'active' : ''" class="menu-item item-curved nbd-tooltop-hover" data-range="true" title="<?php _e('Curved Text','web-to-print-online-designer'); ?>">
