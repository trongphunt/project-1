...
<div class="nbd-popup popup-template-tags" data-animate="scale">
    ...
    <div class="main-popup">
        ...
        <div class="head">
            <?php _e('Template','web-to-print-online-designer'); ?>
        </div>
        <div class="body">
            <div class="main-body tab-scroll">
                <div class="template-name template-field-wrap">
                    <label class="template-label"><?php _e('Name','web-to-print-online-designer'); ?></label>
                    <div>
                        <input type="text" ng-model="customTemplate.name"/>
                    </div>
                </div>
                <div class="template-preview template-field-wrap">
                    <label class="template-label"><?php _e('Thumbnail','web-to-print-online-designer'); ?></label>
                    <div class="nb-radio">
                        <input name="template_preview_type" value="1" ng-model="customTemplate.type" type="radio" id="template_preview_type_1"/> <label for='template_preview_type_1'><?php _e('Default ( the first side )','web-to-print-online-designer'); ?></label>
                    </div>
                    <div class="nb-radio">
                        <input name="template_preview_type" value="2" ng-model="customTemplate.type" type="radio" id="template_preview_type_2"/> <label for='template_preview_type_2'><?php _e('Custom','web-to-print-online-designer'); ?></label>
                    </div>
                ...
                <div class="template-tags template-field-wrap">
                    <label class="template-label"><?php _e('Tags','web-to-print-online-designer'); ?> <span ng-click="reloadTemplateTags()" class="template-tags-reload"><?php _e('Reload','web-to-print-online-designer'); ?></span></label>
                    ...
                    <?php if ( ! empty( $template_tags ) && ! is_wp_error( $template_tags ) ): ?>
                        ...
                        <?php if ( count($template_tags) == 0 ): ?>
                            <a><?php _e('No ','web-to-print-online-designer'); ?></a>
                        <?php endif; ?>
                    </div>
                ...
                <div class="template-tags template-field-wrap">
                    <label class="template-label"><?php _e('Primary colors','web-to-print-online-designer'); ?></label>
                    <div>
                        ...
                        <span class="nbd-gallery-filter-tag add-filter-color-wrap">
                            ...
                            <span class="__add"><?php _e('Add','web-to-print-online-designer'); ?></span>
                            <div class="nbd-gallery-filter-picker" ng-class="customTemplate.showPicker ? 'active' : ''">
                                ...
                                <div>
                                    <button class="nbd-button" ng-click="addTemplateColor(customTemplate.newColor);"><?php _e('Choose','web-to-print-online-designer'); ?></button>
                                </div>
                            </div>
                        </span>
                    </div>
        ...
        <div class="footer">
            <div class="share-btn">
                <span class="nbd-button" ng-click="saveData()"><?php _e('Save template','web-to-print-online-designer'); ?></span>
            </div>
        </div>
    </div>
</div>