<div class="nbd-popup popup-nbd-my-designs-in-cart" data-animate="scale">
    <div class="main-popup" style="padding: 0;width: 80% !important; height: 80%; box-sizing: border-box;">
        ...
        <div class="head">
            <h2 style="font-size: 18px;margin: 0;padding: 20px;font-weight: bold;text-transform: uppercase; border-bottom: 1px solid #ddd;"><?php _e('My designs in cart','web-to-print-online-designer'); ?></h2>
        </div>
