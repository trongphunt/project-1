...
<div class="tour-guide">
    ...
    <?php echo '<script type="text/ng-template" id="tour_guide.typos">'; ?>
        ...
        <div class="tour-intro"><?php _e('Use our extensive font library and formatting options (Alignment, Colors, and Size) to use text in your design.','web-to-print-online-designer'); ?></div>
    <?php echo '</script>'; ?>
    <?php echo '<script type="text/ng-template" id="tour_guide.layers">'; ?>
        <div class="tour-title"><?php _e('Layers','web-to-print-online-designer','web-to-print-online-designer'); ?></div>
        <div class="tour-intro"><?php _e('A simple way to manage and drag to sort the order in layers.','web-to-print-online-designer'); ?></div>
    <?php echo '</script>'; ?>
    ...
    <?php echo '<script type="text/ng-template" id="tour_guide.process">'; ?>
        ...
        <div class="tour-intro"><?php _e('Your design will be saved before continuing with other options or directly add to cart.','web-to-print-online-designer'); ?></div>
    <?php echo '</script>'; ?>
</div>