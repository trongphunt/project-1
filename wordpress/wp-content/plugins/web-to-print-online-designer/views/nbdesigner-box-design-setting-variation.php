                ...
                <div class="nbdesigner-box nbdesigner-box-collapse" data-variation="<?php echo $vid; ?>" style="display: none;">
                    <div class="nbdesigner-image-box">
                        ...
                        <div style="text-align: left; margin: 15px 0;">
                            ...
                            <input type="hidden" value="0" name="_designer_setting<?php echo $vid; ?>[<?php echo $k; ?>][include_background]"/>
                            <input type="checkbox" value="1" name="_designer_setting<?php echo $vid; ?>[<?php echo $k; ?>][include_background]"  <?php checked($include_background); ?>/>
