                            ...
                            <table class="form-table">
                                <tr valign="top">
                                    ...
                                    <td class="forminp-text">
                                        ...
                                        <div style="font-size: 11px; font-style: italic;"><?php _e('Open font file to get the font name, keep the name as in the font file and do not change it ( very important ), Ex:', 'web-to-print-online-designer'); ?><br />
                                ...
                                <tr valign="top">
                                    <th scope="row" class="titledesc"><label for="display_name"><?php echo __("Display name", 'web-to-print-online-designer'); ?></label></th>
                                    <td class="forminp-text">
                                        <input id="display_name" style="min-width: 320px;" type="text" name="display_name" value="<?php $display_name = isset($font_data->display_name) ?  $font_data->display_name : ''; echo $display_name; ?>" />
                                        <p style="font-size: 11px; font-style: italic;"><?php _e('The name will show on design editor.', 'web-to-print-online-designer'); ?></p>
                                    </td>
                                </tr>
                                <tr valign="top">
                                    ...
                                    <td class="forminp-text">
                                        ...
                                        <div class="nbd-font-file-wrap">
                                            ...
                                            <p style="font-family: <?php echo "'".$font_data->alias."', sans-serif"; ?>;font-size: 30px;">
                                                <a download href="<?php echo $url; ?>"><?php echo $preview_text; ?></a>
                                            </p>
                                            <?php endif; ?>
                                        </div>
                                        <div class="nbd-font-file-wrap">
                                        ...
                                        <div style="font-size: 11px; font-style: italic;"><?php _e('Only allow extensions: ttf', 'web-to-print-online-designer'); ?><br />
                                    </td>
                                </tr>
                                <tr valign="top">
