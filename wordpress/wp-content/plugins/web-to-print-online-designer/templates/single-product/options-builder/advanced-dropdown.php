...
<div nbo-adv-dropdown class="nbd-option-field nbd-field-ad-dropdown-wrap <?php echo $class; ?>" ng-if="nbd_fields['<?php echo $field['id']; ?>'].enable">
        ...
        <div>
            ...
            <div class="nbo-ad-pseudo-list <?php if( $sublist_position == 'r' ) echo 'nbo-ad-right'; ?>">
                ...
                <div class="nbo-ad-list-item" 
                     ng-click="select_adv_attr('<?php echo $field['id']; ?>', '<?php echo $key; ?>')"
