...
<div class="nbd-gallery-con">
    ...
    <?php endif; ?>
    <?php 
        $show_sidebar = get_option( 'nbdesigner_gallery_dide_sidebar', 'n' );
        if( $show_sidebar != 'y' ):
    ?>
    ...
    <div class="nbd-list-designs <?php if( $show_sidebar == 'y' ) echo 'nbd-hidden-sidebar'; ?>">
        <?php if( isset( $_GET['tag'] ) || isset( $_GET['color'] ) ): ?>
        <div class="nbd-gallery-filter">
            <span class="nbd-gallery-filter-text"><?php _e("You've Selected", 'web-to-print-online-designer'); ?></span> <?php do_action( 'nbd_gallery_filter' ); ?> <a style="white-space: nowrap;" href="#" class="nbd-gallery-filter-clear"><?php _e("Clear All", 'web-to-print-online-designer'); ?></a>
        </div>
        <?php endif; ?>
