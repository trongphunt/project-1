...
<div class="nbd-designers nbd-sidebar-con">
    ...
    <div class="nbd-sidebar-con-inner">
        <?php foreach( $designers as $designer ): 
            ...
            $artist_name = $designer['art_name'] != '' ? $designer['art_name'] : __('Designer', 'web-to-print-online-designer');
        ?>
        <a href="<?php echo $link_designer; ?>" class="nbd-tag"><span><?php echo $artist_name; ?></span></a>        
        <?php endforeach; ?>
    </div>
</div>  
<div class="nbd-designers nbd-sidebar-con">
