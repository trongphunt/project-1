...
<div class="dokan-other-options dokan-edit-row dokan-clearfix <?php echo $pro_class; ?>" id="nbd-config">
    <div class="dokan-section-heading" data-togglehandler="dokan_other_options">
        <h2><i class="fa fa-picture-o" aria-hidden="true"></i> <?php _e( 'NBDesigner Options', 'web-to-print-online-designer' ); ?></h2>
        <p><?php _e( 'Configure design for product', 'web-to-print-online-designer' ); ?></p>
