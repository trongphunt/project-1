...
<div class="nbdp-popup" id="nbd-catalog-option-popup" data-animate="scale">
    ...
    <div class="main-popup">
        ...
        <div class="nbdp-popup-body">
            <div class="nbco-options-header"><?php _e('How would you love to order?', 'web-to-print-online-designer'); ?></div>
            <div class="nbco-options-wrap">
                <div class="nbco-option nbco-option-upload">
                    <a class="nbco-option-upload-link">
                        ...
                        <div class="nbco-option-text">
                            <p><?php _e('Upload your design', 'web-to-print-online-designer'); ?></p>
                            <p><?php _e('Select this option to upload your print-ready artwork files to our platform.', 'web-to-print-online-designer'); ?></p>
                        </div>
                    </a>
                </div>
                <div class="nbco-option nbco-option-design">
                    <a class="nbco-option-design-link">
                        ...
                        <div class="nbco-option-text">
                            <p><?php _e('Design online', 'web-to-print-online-designer'); ?></p>
                            <p><?php _e('Browse our designs and customize to your taste.', 'web-to-print-online-designer'); ?></p>
                        </div>
                    </a>
                </div>
                ...
                <div class="nbco-option nbco-option-hire">
                    <a class="nbco-option-hire-link">
                        ...
                        <div class="nbco-option-text">
                            <p><?php _e('Request for design', 'web-to-print-online-designer'); ?></p>
                            <p><?php _e('Let our experts help you with your design.', 'web-to-print-online-designer'); ?></p>
                        </div>
                    </a>
                </div>
                <?php endif; ?>
